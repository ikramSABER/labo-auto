...
Naviguer Vers Lien du Ticket Creer par API
    ...
    Go To   https://bouyguestelecomltt3.service-now.com/u_savquality.do?sys_id=9546fcb087ea2610e93e433d8bbb35c4&sysparm_stack=u_savquality_list.do?sysparm_query=active=true
    Sleep    5s